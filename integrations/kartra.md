...
4. Add the following script inside the HEAD TRACKING CODE container labeled `Embed Tracking code into the head`.
...
5. Add the below scripts in the BODY TRACKING CODE container labeled `Embed Tracking code into the body` and save.
