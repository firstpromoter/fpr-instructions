...
```text
Add FirstPromoter&apos;s tracking script to this Django project so we can attribute clicks and signups to referral links.

Find this project&apos;s base template (usually templates/base.html) and insert the snippet below right before the closing &lt;/head&gt; tag, exactly as written, don&apos;t modify it:
...
```text
Find the view/template rendered right after a user signs up or completes checkout in this Django project, and add the snippet below to it (only if the main tracking script isn&apos;t already loaded on this page). Don&apos;t place it on confirmation or thank-you pages that returning users might revisit.
...
&lt;!-- or, if the email is stored in a session variable: --&gt;
&lt;script&gt;
fpr(&quot;referral&quot;,{email:&quot;&#123;&#123; request.session[&apos;email&apos;] &#125;&#125;&quot;})
&lt;/script&gt;
