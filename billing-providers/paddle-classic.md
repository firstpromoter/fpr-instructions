![PaddleClassic](/images/logos/stripe.png)
...
1. Login Paddle > Developer tools din sidebar > Events > click on "+ Add new endpoint"
2. Add in the new field named Webhook Endpoint URL from FirstPromoter.
